...
/**
 * Default logger that logs to Log.
 */
public class DefaultLogger implements Logger {
    ...
    private static class Log {
        ...
        public static final int VERBOSE = 0, DEBUG = 100, INFO = 200, WARN = 300, ERROR = 400, OFF = 1000;
        ...
        public static void d(String name, String message, Throwable t) {
        ...
        public static void v(String name, String message, Throwable t) {
        ...
        public static void w(String name, String message, Throwable t) {

        }
        public static void i(String name, String message) {
        }

        public static void i(String name, String message, Throwable t) {

        }
        public static void e(String name, String message) {
        }

        public static void e(String name, String message, Throwable t) {
