...
import com.twitter.sdk.organic.core.internal.oauth.OAuth1aHeaders;
...
public class OAuthSigning {
    static String getVerifyCredentialsUrl(String baseHostUrl) {
        return baseHostUrl + "/1.1/account/verify_credentials.json";
    }
     ...
     */
    public Map<String, String> getOAuthEchoHeadersForVerifyCredentials(TwitterApi api) {
        return oAuth1aHeaders.getOAuthEchoHeaders(authConfig, authToken, null,
                "GET", getVerifyCredentialsUrl(api.getBaseHostUrl()), null);
    }
